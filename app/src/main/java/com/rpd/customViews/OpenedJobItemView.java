...
public class OpenedJobItemView extends RelativeLayout{
    ...
    public OpenedJobItemView(final Context context, final Job job){
        super(context);
        ...
        confirmImageView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                currentActivity.jobConfirmedByUser(job);
            }
        });
    ...
    private void init() {
        inflate(getContext(), R.layout.item_opened_job, this);
        ...
        this.confirmImageView = findViewById(R.id.confirmImageView);
